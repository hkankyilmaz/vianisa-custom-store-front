export default function CollectionSkeleton() {
  return (
    <>
      <div
        role="status"
        className="w-full border-gray-200 rounded shadow animate-pulse md:p-2 dark:border-gray-700"
      >
        <div className="w-full flex items-center justify-center h-48 mb-4 bg-gray-300 rounded dark:bg-gray-300">
          <svg
        ...
        <div className="flex w-full items-center mt-4">
          ...
          <div>
            <div className="h-2.5  rounded-full dark:bg-transparent w-32 mb-2"></div>
