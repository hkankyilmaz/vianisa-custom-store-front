...
function AnnouncementBar() {
  ...
  return (
    ...
    >
      <span className="announce-item ann-item-one max-md:hidden">
         15% SALE SITEWIDE - USE THE CODE "SAVE15" AT THE CHECKOUT
      </span>
      <span className="announce-item ann-item-one md:hidden">
         15% SALE SITEWIDE <br/>USE THE CODE "SAVE15" AT THE CHECKOUT
      </span>
