      ...
      <div className="px-6 sm:px-[10px] min-[1140px]:px-[40px]">
        <div className="flex flex-col sm:flex-row sm:justify-between flex-wrap gap-12 sm:gap-0">
          ...
          <nav className="mb-0 sm:mb-[50px] px-0 sm:px-[25px] min-[1140px]:basis-[400px]">
            ...
            <div className="mt-[5px] sm:mt-[14px] py-1.5">
              <InstagramButton />
            </div>
          </nav>
        </div>
        <div className="mt-[65px] sm:mt-[40px] min-[1140px]:mt-[80px] flex flex-col sm:flex-row sm:justify-between sm:items-center flex-wrap sm:px-[40px]">
          <NavLink
            end
            to="/"
          ...
          <ul className="flex border-t border-solid border-[var(--footer-border-color)] pt-7 mt-[54px] sm:border-none sm:p-0 sm:mt-0 sm:-mr-2 max-sm:justify-center">
            <li className="my-1.5 mx-2">
              <AmericanExpressIcon />
            </li>
            <li className="my-1.5 mx-2">
              <ApplePayIcon />
...
const InstagramButton = () => {
  return (
    ...
    >
      <span className="bg-transparent relative cursor-pointer before:cursor-pointer before:-inset-y-[8px] before:-inset-x-[12px] before:absolute text-[var(--footer-text-color)] text-[13px]">
        <svg
