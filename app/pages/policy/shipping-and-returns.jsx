...
export default function Product() {
  ...
  let newkomp = (
    <>
      <div className="text-[13px] mb-[40px]">
        <h3 className="text-[13px] mb-[20.8px]">
          <strong>FREE SHIPPING</strong>
        </h3>
        <p className="text-[13px] mb-[20.8px]">
      ...
      <div className="text-[13px] mb-[20.8px]">
        <h3 className="text-[13px] mb-[20.8px]">
        ...
        <ul className="pl-[30px] text-[13px] mb-[20.8px]">
          <li>
            <h4 className="text-[13px] mb-[20.8px]">
